...
if (!Array) {
  ...
  (_easycom_cl_select_picker2 + _easycom_uni_easyinput2 + _easycom_uni_forms_item2 + _easycom_uni_forms2)();
}
...
if (!Math) {
  (_easycom_cl_select_picker + _easycom_uni_easyinput + _easycom_uni_forms_item + _easycom_uni_forms)();
}
const _sfc_main = {
  __name: "index",
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        j: common_vendor.t(formData.picker1),
        k: common_vendor.o(formSubmit),
        l: common_vendor.sr(formRef, "17f399f1-1", {
          "k": "formRef"
        }),
        m: common_vendor.p({
          modelValue: formData,
