...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    common_vendor.watch(() => props.list, (newV) => {
      filterList.value = newV;
    }, {
      immediate: true,
      deep: true
    });
    const emptyIconSrc = common_vendor.computed(() => {
    ...
    const refreshLoading = common_vendor.ref(false);
    ...
    const load = async (type) => {
      ...
      if (filterList.value.length === 0) {
        ...
        common_vendor.index.__f__("log", "at uni_modules/cl-auto-page-list/components/cl-auto-page-list/cl-auto-page-list.vue:106", filterList, startIdx, endIdx);
    ...
    const search = () => {
      ...
      common_vendor.index.__f__("log", "at uni_modules/cl-auto-page-list/components/cl-auto-page-list/cl-auto-page-list.vue:121", filterList.value, "filterList.value");
      curPage.value = 1;
      isEnd.value = false;
      showList.value = [];
      load();
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        d: loadMoreStatus.value === "noData"
      }, loadMoreStatus.value === "noData" ? {
        e: emptyIconSrc.value,
        f: common_vendor.t(__props.emptyText)
      } : {}, {
        g: screenTop.value,
        h: refreshLoading.value,
        i: __props.lowerThreshold,
        j: common_vendor.o(scrollView),
        k: common_vendor.o(bootmScroll),
        l: common_vendor.o(refresherrefresh)
      });
    };
  }
};
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-40e80ac4"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/uni_modules/cl-auto-page-list/components/cl-auto-page-list/cl-auto-page-list.js.map
