...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__4FC0FD4",
    appName: "code_life_components",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.3.128,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_dF7E55";
...
const pages = [
  ...
  {
    path: "pages/componentPage/cl-tabs/index",
    style: {
      navigationBarTitleText: "tabs组件"
    }
  },
  {
    path: "pages/componentPage/cl-table/index",
    style: {
