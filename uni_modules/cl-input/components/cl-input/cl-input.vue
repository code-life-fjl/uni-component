...
<style lang="scss">
	...
	.text_maxlength_show {
		padding: 0 10rpx;font-size: 12px;
	}
	.textarea_maxlength_show {
		padding: 0 10rpx;position: absolute;bottom: -36rpx;right: 0;font-size: 12px;
	}
	.pev-none {
		pointer-events: none;
	}
